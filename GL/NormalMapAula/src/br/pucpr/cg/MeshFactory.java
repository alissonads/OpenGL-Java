...
public class MeshFactory {
    ...
    public static Mesh createSquareWithNormalMap() {
        ...
        for (int i = 0; i < indices.size(); i+= 3) {
            ...
            Vector2f texSide1 = new Vector2f(texCoords.get(1)).sub(texCoords.get(0));
            Vector2f texSide2 = new Vector2f(texCoords.get(2)).sub(texCoords.get(0));
            		
            float f = 1.0f / (texSide1.x * texSide2.y - texSide2.x * texSide1.y);
            
            Vector3f tangent = new Vector3f(f * (texSide2.y * side1.x - texSide1.y * side2.x),
