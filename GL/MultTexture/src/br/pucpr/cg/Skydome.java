...
public class Skydome implements Scene {
    ...
    public void init() {
        ...
        skyMaterial.setTexture(new Texture("img/opengl/textures/cloud1.png"), new Texture("img/opengl/textures/cloud2.png"));
        
        try {
            mesh = MeshFactory.loadTerrain(new File("img/opengl/heights/river.png"), 0.4f, 3);
        } catch (IOException e) {
        ...
        material.setTexture(new Texture("img/opengl/textures/sand.png"),
						    new Texture("img/opengl/textures/grass.png"),
						    new Texture("img/opengl/textures/rock.png"),
						    new Texture("img/opengl/textures/snow.png"));
        //BlendMap
        material.setTexture("uBlendMap", new Texture("img/opengl/textures/BlendMap.png"));
